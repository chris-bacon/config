...
/* package my-nvim-hs-0.1.0.0 */
#ifndef VERSION_my_nvim_hs
#define VERSION_my_nvim_hs "0.1.0.0"
#endif /* VERSION_my_nvim_hs */
#ifndef MIN_VERSION_my_nvim_hs
#define MIN_VERSION_my_nvim_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_nvim_hs */
...
/* package unliftio-0.2.10 */
#ifndef VERSION_unliftio
#define VERSION_unliftio "0.2.10"
...
#define CURRENT_COMPONENT_ID "my-nvim-hs-0.1.0.0-92PsqAUoqBw5X8uX0HEDmn-my-nvim-hs"
